                      ...
                      customButton(
                          onPress: () {
                            if (controller.selectedCategory.value.isEmpty ||
                                controller.testNamecontrollre.text.isEmpty ||
                                controller.testPricecontrollre.text.isEmpty ||
                                controller
                                    .relevantDiseasescontrollre.text.isEmpty ||
                                controller.sampleTypecontrollre.text.isEmpty ||
                                controller
                                    .referenceRangecontrollre.text.isEmpty ||
                                controller
                                    .testDescriptioncontrollre.text.isEmpty) {
                              Utils.toast(
                              ...
                              controller.addNewTest(
                                  ...
                                  testDescription: controller
                                      ...
                                      .toString(),
                                  testPrice: controller.testPricecontrollre.text
                                      .toString(),
                        ...
                        children: [
                                            ...
                                            : ListView(
                                                ...
                                                children: List.generate(
                                                    ...
                                                    (index) => Text(controller
                                                            ...
                                                            index])
                                                        .box
                                                        .roundedSM.padding(const EdgeInsets.all(5))
                          ...
                          SizedBox(
                            ...
                            child: customTextFieldsForTests(
                              ...
                              hintText: "Purpose and siginificance of package",
                            ),
                          ),
                          20.heightBox,
                          ...
                          customButton(
                              onPress: () {
                                if (controller
                                    ...
                                    controller.seletedTestslist.isEmpty ||
                                    controller
                                        .actualPriceController.text.isEmpty ||
                                    controller.piscountedPriceController.text
                                        .isEmpty ||
                                    controller
                                        .sampleCollectionInstructioncontrollre
                                        .text
